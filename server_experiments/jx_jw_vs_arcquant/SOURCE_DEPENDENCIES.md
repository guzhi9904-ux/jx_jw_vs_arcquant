...
scripts/evaluate_joint_ks_tasks.py
...
- `evaluate_joint_ks_tasks.py`: reuses the PPL evaluator's exact fake-NVFP4 wrappers for the paper-aligned five zero-shot tasks and 5-shot MMLU through pinned `lm-eval==0.4.8`.
